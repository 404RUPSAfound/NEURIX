...
echo [1/3] Starting Main Backend on Port 8001...
start "NEURIX-Backend" cmd /k "cd Backend && venv\Scripts\activate 2>nul || python -m venv venv && venv\Scripts\activate && pip install -r requirements.txt & uvicorn api:app --reload --port 8001"

:: 2. Start Satellite Backend (Node.js/Express)
echo [2/3] Starting Satellite Backend on Port 3001...
